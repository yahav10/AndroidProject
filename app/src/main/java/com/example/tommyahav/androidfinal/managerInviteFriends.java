...
public class managerInviteFriends extends AppCompatActivity {
...
//        Button managerSignUpButton = (Button)findViewById(R.id.managerSignUpButton);
//        managerSignUpButton.setOnClickListener(new Button.OnClickListener() {
//            public void onClick(View v) {
